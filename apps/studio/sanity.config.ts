...
import { apiVersion, dataset, projectId, studioUrl } from './src/lib/api';
import { pageStructure, singletonPlugin } from './src/plugins/settings';
import { assistWithPresets } from './src/plugins/assist';
import author from './src/schemas/documents/author';
import post from './src/schemas/documents/post';
